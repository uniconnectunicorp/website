...
export default function CoursesSection({ coursesQuantity, initialCourses, aproveitamento  }) {
            ...
            <div className="mt-16 text-center">
               {!isSearchMode && courses.length < coursesQuantity && (
                <Button
                    ...
                    border-2 ${!aproveitamento ? 'border-[#0b3b75] text-[#0b3b75] hover:bg-[#0b3b75] hover:shadow-md hover:border-[#0b3b75]' : 'border-[#ff6600] text-[#ff6600] hover:bg-[#ff6600] hover:shadow-md hover:border-[#ff6600]'}
                ...
                >
                    ...
                    {loading && (
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className={`h-5 w-5 border-2 ${!aproveitamento ? 'border-[#0b3b75] border-t-transparent' : 'border-[#ff6600] border-t-transparent'} rounded-full animate-spin`} />
                        </div>
                    )}
                </Button>
                )}
