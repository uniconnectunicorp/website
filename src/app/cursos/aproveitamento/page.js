...
export default function AproveitamentoPage() {
  ...
  return (
    <>
      <Head title="Uniconnect | Cursos por Aproveitamento" description="Encontre o seu caminho para o sucesso!" />
      ...
      <div className="min-h-screen pt-20">
        ...
        <section className="relative bg-gradient-to-r from-[#0b3b75] to-[#0b3b75] text-white pt-9 pb-6">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Nossos Cursos por Aproveitamento</h1>
        ...
        <CoursesSection coursesQuantity={courses} initialCourses={initialCourses} aproveitamento={true} />
