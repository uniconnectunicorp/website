            ...
            {navigation.map((item, index) => {
              ...
              return (
                <Link
                  ...
                  className={`group flex items-center justify-between px-4 py-4 text-base font-medium transition-all duration-300 rounded-xl transform hover:scale-[1.02] ${
                    isActive
                ...
                >
                  ...
                  <ChevronRight className={`h-5 w-5 transition-transform duration-300 ${
                    isActive ? 'text-white/80' : 'text-gray-400 group-hover:text-[#0b3b75] group-hover:translate-x-1'
                  }`} />
                </Link>
              );
            })}
