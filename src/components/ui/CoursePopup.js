...
import { X, BookOpen, Clock, Award, TrendingUp, CheckCircle, Zap, Target, Brain, Briefcase, GraduationCap, Sparkles, ChevronRight, Star, Gift, Users } from 'lucide-react';
...
export default function CoursePopup() {
  ...
  useEffect(() => {
    const checkAndShowPopup = () => {
      const lastShown = localStorage.getItem('coursePopupLastShown');
  ...
  const handleClose = () => {
    setIsOpen(false);
    localStorage.setItem('coursePopupLastShown', new Date().toDateString());
  };
                    ...
                    <div>
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          className="bg-gradient-to-r from-[#ff6600]/10 via-[#ff8800]/10 to-[#0b3b75]/10 rounded-2xl p-4 border-2 border-[#ff6600]/30 shadow-lg"
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="text-base font-bold text-gray-900">Vagas Limitadas</h3>
