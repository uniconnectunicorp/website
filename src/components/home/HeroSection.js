          ...
          <div className="space-y-8">
            ...
            >
              ...
              >
                <Link
                  href="/cursos"
                  className="inline-flex items-center justify-center px-8 py-4 text-base font-medium text-white bg-[#ff4c00] hover:bg-orange-700 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] hover:shadow-orange-200"
                >
