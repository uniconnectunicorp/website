...
async function seedPaymentMethods() {
  ...
  const methods = [
    ...
    { id: 'pm_boleto',    name: 'Boleto',                type: 'boleto' as const, maxInstallments: null, feePercentage: 0,     commissionPercentage: 5, commissionType: 'fixed', visibleOnEnrollment: true },
  ]
